...
function App() {
  ...
  const [pokemonhos, setPokemonhos] = useState([
    {
      id: 200,
      nome: "Misdreavus",
      imagem: "https://img.pokemondb.net/sprites/home/normal/misdreavus.png",
    },
    {
      id: 201,
      nome: "Unown",
      imagem: "https://img.pokemondb.net/sprites/home/normal/unown.png",
    },
    {
      id: 202,
      nome: "Wobbuffet",
      imagem: "https://img.pokemondb.net/sprites/home/normal/wobbuffet.png",
    },
    {
      id: 203,
      nome: "Girafarig",
      imagem: "https://img.pokemondb.net/sprites/home/normal/girafarig.png",
    },
    {
      id: 204,
      nome: "Pineco",
      imagem: "https://img.pokemondb.net/sprites/home/normal/pineco.png",
    },
    {
      id: 205,
      nome: "Forretress",
      imagem: "https://img.pokemondb.net/sprites/home/normal/forretress.png",
    },
    {
      id: 206,
      nome: "Dunsparce",
      imagem: "https://img.pokemondb.net/sprites/home/normal/dunsparce.png",
    },
    {
      id: 207,
      nome: "Gligar",
      imagem: "https://img.pokemondb.net/sprites/home/normal/gligar.png",
    },
    {
      id: 208,
      nome: "Steelix",
      imagem: "https://img.pokemondb.net/sprites/home/normal/steelix.png",
    },
    {
      id: 209,
      nome: "Snubbull",
      imagem: "https://img.pokemondb.net/sprites/home/normal/snubbull.png",
    },
  ]);
  ...
  const [notas, setNotas] = useState([
    {
      ...
      materia: "Cálculo I",
      nota: 4.5,
      desculpa: "O professor usou letras onde deveriam estar números.",
    },
    { id: 401, materia: "História", nota: 9.0, desculpa: null },
    {
      ...
      materia: "Física",
      nota: 3.0,
      desculpa: "A gravidade não colaborou no dia da prova prática.",
    },
    { id: 403, materia: "Literatura", nota: 8.5, desculpa: null },
    {
      ...
      materia: "Química",
      nota: 5.5,
      desculpa: "Inalei muito hélio e esqueci a tabela periódica.",
    },
    { id: 405, materia: "Geografia", nota: 7.2, desculpa: null },
    {
      ...
      materia: "Biologia",
      nota: 6.0,
      desculpa: "Fiquei com pena de dissecar o sapo e me desconcentrei.",
    },
    { id: 407, materia: "Filosofia", nota: 10, desculpa: null },
    {
      ...
      materia: "Inglês",
      nota: 4.0,
      desculpa: "O sotaque do áudio parecia um alienígena mastigando chiclete.",
    },
    {
      id: 409,
      materia: "Artes",
      nota: 6.8,
      desculpa: "Minha visão artística está à frente do tempo do professor.",
    },
  ]);
  ...
  const [tarefas, setTarefas] = useState([
    ...
    {
      id: 710,
      titulo: "Refatorar hooks",
      responsavel: "Kevin Silva",
      concluido: true,
    },
    {
      id: 711,
      titulo: "Corrigir bug de scroll",
      responsavel: "Larissa Faria",
      concluido: false,
    },
    {
      id: 712,
      titulo: "Atualizar dependências",
  ...
  const [posts, setPosts] = useState([
    {
      id: 800,
      emoji: "🚀",
      texto: "Partiu dominar o React!",
      hashtags: ["#coding", "#frontend"],
      curtidas: 45,
    },
    {
      id: 801,
      emoji: "☕",
      texto: "Café e código, a combinação perfeita.",
      hashtags: ["#devlife", "#coffee"],
      curtidas: 120,
    },
    {
      id: 802,
      emoji: "🌊",
      texto: "Aproveitando o dia na praia.",
      hashtags: ["#summer", "#vibe"],
      curtidas: 89,
    },
    {
      id: 803,
      emoji: "💡",
      texto: "Tive uma ideia incrível para um app hoje.",
      hashtags: ["#startup", "#ideas"],
      curtidas: 34,
    },
    {
      id: 804,
      emoji: "💻",
      texto: "Setup novo finalmente montado!",
    ...
    },
    {
      id: 805,
      emoji: "🍕",
      texto: "Sexta-feira pede uma pizza.",
      hashtags: ["#food", "#friday"],
      curtidas: 67,
    },
    {
      id: 806,
      emoji: "📚",
      texto: "Terminei de ler 'Código Limpo' hoje.",
      hashtags: ["#cleanclode", "#learning"],
      curtidas: 55,
    },
    {
      id: 807,
      emoji: "🏃‍♂️",
      texto: "Corrida matinal paga!",
    ...
    },
    {
      id: 808,
      emoji: "🎨",
      texto: "Explorando novas paletas de cores.",
    ...
    },
    {
      id: 809,
      emoji: "✈️",
      texto: "Próxima parada: conferência de tech.",
      hashtags: ["#travel", "#devconf"],
      curtidas: 156,
    },
    {
      id: 810,
      emoji: "🎸",
      texto: "Praticando um pouco de guitarra.",
      hashtags: ["#music", "#hobby"],
      curtidas: 28,
    },
    {
      id: 811,
      emoji: "🐶",
      texto: "O novo estagiário é muito fofo.",
      hashtags: ["#dog", "#officelife"],
      curtidas: 315,
    },
    {
      id: 812,
      emoji: "🌚",
      texto: "Codando no escuro até tarde.",
      hashtags: ["#nightowl", "#programming"],
      curtidas: 72,
    },
  ]);
